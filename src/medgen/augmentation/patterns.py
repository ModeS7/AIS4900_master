...
Pattern IDs (16 total):
    0-3:   Checkerboard variants (4x4 std, 4x4 offset, 8x8 std, 8x8 offset)
    4-7:   Grid dropout variants (4x4 25% seed0, 4x4 25% seed1, 4x4 50% seed0, 4x4 50% seed1)
    8-11:  Coarse dropout patterns (diagonal1, diagonal2, tri, corners)
    12-15: Patch dropout variants (8x8 25% seedA, 8x8 25% seedB, 8x8 50% seedA, 8x8 50% seedB)
