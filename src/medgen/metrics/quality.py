...
# - compute_perceptual_distance_3d(): Uses 2.5D slice-by-slice computation because
#   the perceptual backbone relies on 2D pretrained networks (ImageNet/RadImageNet). Cannot unify.
