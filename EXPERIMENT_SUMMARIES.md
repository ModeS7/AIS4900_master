...
## IDUN log cross-reference

Maps each TB run in this document to its corresponding SLURM job(s) in
[`IDUN_LOG_SUMMARIES.md`](IDUN_LOG_SUMMARIES.md). Many TB runs span
multiple SLURM jobs (chain-resumes); all matching jobs are listed.
TB runs without a matched IDUN job are typically older runs whose
stdout files were rotated off disk.

- `compression_3d/seg/exp11_2_vqvae3d_seg_256x160_20260112-012254` → `exp11_2_vqvae3d_seg_23889173` (completed)
- `diffusion_2d/bravo/exp13_1_ema_simple_rflow_128_20260109-213446` → `exp13_1_ema_simple_23888433` (completed)
- `diffusion_2d/bravo/exp13_2_ema_slow_rflow_128_20260109-213501` → `exp13_2_ema_slow_23888434` (completed)
- `diffusion_2d/bravo/exp16_bs24_rflow_128_20260111-190650` → `exp16_bs24_23889064` (completed)
- `diffusion_2d/bravo/exp16_bs32_rflow_128_20260111-205709` → `exp16_bs32_23889063` (truncated)
- `diffusion_2d/bravo/exp16_bs4_rflow_128_20260111-190651` → `exp16_bs4_23889065` (completed)
- `diffusion_2d/bravo/exp16_bs8_rflow_128_20260111-190651` → `exp16_bs8_23889066` (completed)
- `diffusion_2d/bravo/exp1_2_ddpm_128_20251223-233504` → `exp1_2_ddpm_23872208` (crashed)
- `diffusion_2d/bravo/exp2_bf16mse_rflow_128_20260108-002738` → `exp2_bf16mse_23885956` (crashed)
- `diffusion_2d/bravo/exp6_rflow_256_20251221-173255` → `exp6_rflow_256_23870730` (oom_killed)
- `diffusion_3d/bravo/exp1_1_pixel_bravo_20260301-180232` → `exp1_1_pixel_bravo_23969658` (truncated), `exp1_1_pixel_bravo_23989010` (oom_killed), `exp1_1_pixel_bravo_23982866` (oom_killed)
- `diffusion_3d/bravo/exp1_pixel_bravo_20260224-163719` → `exp1_pixel_bravo_23969657` (truncated), `exp1_pixel_bravo_23989011` (crashed), `exp1_pixel_bravo_23982867` (crashed), `exp1_pixel_bravo_23985116` (crashed)
- `diffusion_3d/bravo/exp1e_1_pixel_bravo_snr_gamma_rflow_256x160_20260225-031917` → `exp1e_1_pixel_bravo_snr_gamma_24072109` (completed)
- `diffusion_3d/bravo/exp1e_pixel_bravo_snr_gamma_rflow_128x160_20260225-015538` → `exp1e_pixel_bravo_snr_gamma_24072105` (completed)
- `diffusion_3d/bravo/exp1f_1_pixel_bravo_edm_precond_rflow_256x160_20260225-033959` → `exp1f_1_pixel_bravo_edm_precond_24072110` (completed)
- `diffusion_3d/bravo/exp1f_pixel_bravo_edm_precond_rflow_128x160_20260225-022154` → `exp1f_pixel_bravo_edm_precond_24072106` (completed)
- `diffusion_3d/bravo/exp4_pixel_bravo_sda_rflow_128x160_20260130-025210` → `exp4_pixel_bravo_sda_23989012` (crashed), `exp4_pixel_bravo_sda_23973532` (crashed), `exp4_pixel_bravo_sda_23987602` (truncated)
- `diffusion_3d/bravo/exp5_1_pixel_bravo_scoreaug_rflow_128x160_20260130-030053` → `exp5_1_pixel_bravo_scoreaug_23989013` (crashed), `exp5_1_pixel_bravo_scoreaug_23973838` (crashed), `exp5_1_pixel_bravo_scoreaug_23987603` (crashed)
- `diffusion_3d/bravo/exp6a_pixel_bravo_controlnet_stage1_rflow_128x160_20260130-033231` → `exp6a_pixel_bravo_controlnet_stage1_23989014` (crashed), `exp6a_pixel_bravo_controlnet_stage1_23982865` (crashed), `exp6a_pixel_bravo_controlnet_stage1_23987604` (crashed)
- `diffusion_3d/bravo/exp7_sit_b_128_patch8_2000_rflow_128x160_20260130-133403` → `exp7_sit_b_128_patch8_2000_23989812` (crashed)
- `diffusion_3d/bravo/exp7_sit_b_128_patch8_rflow_128x160_20260130-145402` → `exp7_sit_b_128_patch8_23989813` (crashed), `exp7_sit_b_128_patch8_23983258` (crashed), `exp7_sit_b_128_patch8_23987610` (crashed)
- `diffusion_3d/bravo/exp8_pixel_bravo_ema_rflow_128x160_20260131-061549` → `exp8_pixel_bravo_ema_23991162` (crashed)
- `diffusion_3d/bravo_latent/exp9_1_ldm_4x_bravo_20260222-225625` → `exp9_1_ldm_4x_bravo_24036417` (truncated)
- `diffusion_3d/bravo_latent/exp9_ldm_8x_bravo_rflow_256x160_20260223-012214` → `exp9_ldm_8x_bravo_23997506` (truncated), `exp9_ldm_8x_bravo_24039867` (truncated), `exp9_ldm_8x_bravo_24063647` (oom_killed)
- `diffusion_3d/cfg/exp1_debugging_cfg_rflow_128x160_20260128-223445` → `exp1_debugging_cfg_23984445` (crashed), `exp1_debugging_cfg_23985115` (crashed)
- `diffusion_3d/cfg/exp1_pixel_bravo_rflow_128x160_20260128-223458` → `exp1_pixel_bravo_23969657` (truncated), `exp1_pixel_bravo_23989011` (crashed), `exp1_pixel_bravo_23982867` (crashed), `exp1_pixel_bravo_23985116` (crashed)
- `diffusion_3d/cfg/exp4_pixel_bravo_sda_rflow_128x160_20260129-022356` → `exp4_pixel_bravo_sda_23989012` (crashed), `exp4_pixel_bravo_sda_23973532` (crashed), `exp4_pixel_bravo_sda_23987602` (truncated)
- `diffusion_3d/cfg/exp5_1_pixel_bravo_scoreaug_rflow_128x160_20260129-022356` → `exp5_1_pixel_bravo_scoreaug_23989013` (crashed), `exp5_1_pixel_bravo_scoreaug_23973838` (crashed), `exp5_1_pixel_bravo_scoreaug_23987603` (crashed)
- `diffusion_3d/cfg/exp6a_pixel_bravo_controlnet_stage1_rflow_128x160_20260129-063540` → `exp6a_pixel_bravo_controlnet_stage1_23989014` (crashed), `exp6a_pixel_bravo_controlnet_stage1_23982865` (crashed), `exp6a_pixel_bravo_controlnet_stage1_23987604` (crashed)
- `diffusion_3d/cfg/exp7_sit_b_128_patch8_rflow_128x160_20260129-074908` → `exp7_sit_b_128_patch8_23989813` (crashed), `exp7_sit_b_128_patch8_23983258` (crashed), `exp7_sit_b_128_patch8_23987610` (crashed)
- `diffusion_3d/cfg/exp7_sit_l_128_patch8_rflow_128x160_20260129-083948` → `exp7_sit_l_128_patch8_23983257` (crashed), `exp7_sit_l_128_patch8_23987611` (crashed)
- `diffusion_3d/cfg/exp7_sit_s_128_patch8_rflow_128x160_20260129-072436` → `exp7_sit_s_128_patch8_23982977` (truncated), `exp7_sit_s_128_patch8_23987609` (crashed)
- `diffusion_3d/cfg/exp7_sit_xl_128_patch8_rflow_128x160_20260129-084435` → `exp7_sit_xl_128_patch8_23984267` (crashed), `exp7_sit_xl_128_patch8_23987612` (crashed)
- `diffusion_3d/old-discard/exp1_1_pixel_bravo_rflow_256x160_20260119-212710` → `exp1_1_pixel_bravo_23969658` (truncated), `exp1_1_pixel_bravo_23989010` (oom_killed), `exp1_1_pixel_bravo_23982866` (oom_killed)
- `diffusion_3d/old-discard/exp1_1_pixel_bravo_rflow_256x160_20260126-183654` → `exp1_1_pixel_bravo_23969658` (truncated), `exp1_1_pixel_bravo_23989010` (oom_killed), `exp1_1_pixel_bravo_23982866` (oom_killed)
- `diffusion_3d/old-discard/exp1_1_pixel_bravo_rflow_256x160_20260129-233435` → `exp1_1_pixel_bravo_23969658` (truncated), `exp1_1_pixel_bravo_23989010` (oom_killed), `exp1_1_pixel_bravo_23982866` (oom_killed)
- `diffusion_3d/old-discard/exp1_debugging_cfg_rflow_128x160_20260128-025709` → `exp1_debugging_cfg_23984445` (crashed), `exp1_debugging_cfg_23985115` (crashed)
- `diffusion_3d/old-discard/exp1_pixel_bravo_rflow_128x160_20260126-184743` → `exp1_pixel_bravo_23969657` (truncated), `exp1_pixel_bravo_23989011` (crashed), `exp1_pixel_bravo_23982867` (crashed), `exp1_pixel_bravo_23985116` (crashed)
- `diffusion_3d/old-discard/exp4_1_pixel_bravo_sda_rflow_128x160_20260127-043308` → `exp4_1_pixel_bravo_sda_23982869` (crashed)
- `diffusion_3d/old-discard/exp4_pixel_bravo_sda_rflow_128x160_20260122-130906` → `exp4_pixel_bravo_sda_23989012` (crashed), `exp4_pixel_bravo_sda_23973532` (crashed), `exp4_pixel_bravo_sda_23987602` (truncated)
- `diffusion_3d/old-discard/exp5_1_pixel_bravo_scoreaug_rflow_128x160_20260123-024740` → `exp5_1_pixel_bravo_scoreaug_23989013` (crashed), `exp5_1_pixel_bravo_scoreaug_23973838` (crashed), `exp5_1_pixel_bravo_scoreaug_23987603` (crashed)
- `diffusion_3d/old-discard/exp5_2_pixel_bravo_scoreaug_compose_rflow_128x160_20260123-024808` → `exp5_2_pixel_bravo_scoreaug_compose_23973839` (crashed)
- `diffusion_3d/old-discard/exp5_3_pixel_bravo_scoreaug_rflow_128x160_20260126-214534` → `exp5_3_pixel_bravo_scoreaug_23982868` (crashed)
- `diffusion_3d/old-discard/exp6a_pixel_bravo_controlnet_stage1_rflow_128x160_20260126-181256` → `exp6a_pixel_bravo_controlnet_stage1_23989014` (crashed), `exp6a_pixel_bravo_controlnet_stage1_23982865` (crashed), `exp6a_pixel_bravo_controlnet_stage1_23987604` (crashed)
- `diffusion_3d/old-discard/exp7_1_sit_b_256_patch16_rflow_256x160_20260127-133520` → `exp7_1_sit_b_256_patch16_23983255` (crashed)
- `diffusion_3d/old-discard/exp7_1_sit_l_256_patch16_rflow_256x160_20260127-182806` → `exp7_1_sit_l_256_patch16_23983256` (crashed)
- `diffusion_3d/old-discard/exp7_1_sit_s_256_patch16_rflow_256x160_20260127-051957` → `exp7_1_sit_s_256_patch16_23982976` (truncated)
- `diffusion_3d/old-discard/exp7_1_sit_xl_256_patch16_rflow_256x160_20260127-212438` → `exp7_1_sit_xl_256_patch16_23984266` (crashed)
- `diffusion_3d/old-discard/exp7_sit_b_128_patch8_rflow_128x160_20260127-194653` → `exp7_sit_b_128_patch8_23989813` (crashed), `exp7_sit_b_128_patch8_23983258` (crashed), `exp7_sit_b_128_patch8_23987610` (crashed)
- `diffusion_3d/old-discard/exp7_sit_l_128_patch8_rflow_128x160_20260127-194155` → `exp7_sit_l_128_patch8_23983257` (crashed), `exp7_sit_l_128_patch8_23987611` (crashed)
- `diffusion_3d/old-discard/exp7_sit_s_128_patch8_rflow_128x160_20260127-051957` → `exp7_sit_s_128_patch8_23982977` (truncated), `exp7_sit_s_128_patch8_23987609` (crashed)
- `diffusion_3d/old-discard/exp7_sit_xl_128_patch8_rflow_128x160_20260128-000337` → `exp7_sit_xl_128_patch8_23984267` (crashed), `exp7_sit_xl_128_patch8_23987612` (crashed)
- `diffusion_3d/old-discard/exp9_0_ldm_8x_bravo_small_20260221-215044` → `exp9_0_ldm_8x_bravo_small_23997680` (truncated), `exp9_0_ldm_8x_bravo_small_23997808` (crashed), `exp9_0_ldm_8x_bravo_small_24061951` (truncated), `exp9_0_ldm_8x_bravo_small_24062097` (truncated), `exp9_0_ldm_8x_bravo_small_24062563` (completed)
- `diffusion_3d/old-discard/exp9_0_ldm_8x_bravo_small_rflow_256x160_20260201-193834` → `exp9_0_ldm_8x_bravo_small_23997680` (truncated), `exp9_0_ldm_8x_bravo_small_23997808` (crashed), `exp9_0_ldm_8x_bravo_small_24061951` (truncated), `exp9_0_ldm_8x_bravo_small_24062097` (truncated), `exp9_0_ldm_8x_bravo_small_24062563` (completed)
- `diffusion_3d/old-discard/exp9_1_ldm_4x_bravo_20260221-224417` → `exp9_1_ldm_4x_bravo_24036417` (truncated)
- `diffusion_3d/old-discard/exp9_1_ldm_4x_bravo_rflow_256x160_20260211-124914` → `exp9_1_ldm_4x_bravo_24036417` (truncated)
- `diffusion_3d/old-discard/exp9_ldm_4x_bravo_rflow_256x160_20260201-155324` → `exp9_ldm_4x_bravo_23997507` (truncated), `exp9_ldm_4x_bravo_24039868` (truncated)
- `diffusion_3d/old-discard/exp9_ldm_4x_bravo_rflow_256x160_20260213-025522` → `exp9_ldm_4x_bravo_23997507` (truncated), `exp9_ldm_4x_bravo_24039868` (truncated)
- `diffusion_3d/old-discard/exp9_ldm_8x_bravo_rflow_256x160_20260201-155324` → `exp9_ldm_8x_bravo_23997506` (truncated), `exp9_ldm_8x_bravo_24039867` (truncated), `exp9_ldm_8x_bravo_24063647` (oom_killed)
- `diffusion_3d/old-discard/exp9_ldm_8x_bravo_rflow_256x160_20260213-025408` → `exp9_ldm_8x_bravo_23997506` (truncated), `exp9_ldm_8x_bravo_24039867` (truncated), `exp9_ldm_8x_bravo_24063647` (oom_killed)
- `diffusion_3d/seg/exp2_1_pixel_seg_sizebin_rflow_256x160_20260122-131414` → `exp2_1_pixel_seg_sizebin_23996728` (truncated), `exp2_1_pixel_seg_sizebin_23973544` (oom_killed), `exp2_1_pixel_seg_sizebin_23982950` (oom_killed)
- `diffusion_3d/seg/exp2_1_pixel_seg_sizebin_rflow_256x160_20260127-043308` → `exp2_1_pixel_seg_sizebin_23996728` (truncated), `exp2_1_pixel_seg_sizebin_23973544` (oom_killed), `exp2_1_pixel_seg_sizebin_23982950` (oom_killed)
- `diffusion_3d/seg/exp2_1_pixel_seg_sizebin_rflow_256x160_20260201-015003` → `exp2_1_pixel_seg_sizebin_23996728` (truncated), `exp2_1_pixel_seg_sizebin_23973544` (oom_killed), `exp2_1_pixel_seg_sizebin_23982950` (oom_killed)
- `diffusion_3d/seg/exp2_pixel_seg_sizebin_rflow_128x160_20260121-163331` → `exp2_pixel_seg_sizebin_23972121` (truncated), `exp2_pixel_seg_sizebin_23996720` (truncated), `exp2_pixel_seg_sizebin_23982949` (truncated)
- `diffusion_3d/seg/exp2_pixel_seg_sizebin_rflow_128x160_20260127-043308` → `exp2_pixel_seg_sizebin_23972121` (truncated), `exp2_pixel_seg_sizebin_23996720` (truncated), `exp2_pixel_seg_sizebin_23982949` (truncated)
- `diffusion_3d/seg/exp2_pixel_seg_sizebin_rflow_128x160_20260201-014505` → `exp2_pixel_seg_sizebin_23972121` (truncated), `exp2_pixel_seg_sizebin_23996720` (truncated), `exp2_pixel_seg_sizebin_23982949` (truncated)
- `diffusion_3d/seg/exp2b_1_pixel_seg_input_cond_rflow_256x160_20260201-133413` → `exp2b_1_pixel_seg_input_cond_23997358` (truncated), `exp2b_1_pixel_seg_input_cond_23982974` (crashed)
- `diffusion_3d/seg/exp2b_pixel_seg_input_cond_rflow_128x160_20260201-025016` → `exp2b_pixel_seg_input_cond_23996776` (truncated), `exp2b_pixel_seg_input_cond_23982975` (crashed)
- `diffusion_3d/seg/exp2c_1_pixel_seg_improved_20260218-183155` → `exp2c_1_pixel_seg_improved_24039864` (oom_killed)
- `diffusion_3d/seg/exp2c_pixel_seg_improved_20260218-183124` → `exp2c_pixel_seg_improved_24031953` (crashed)---
